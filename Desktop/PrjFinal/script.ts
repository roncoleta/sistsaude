document.addEventListener("DOMContentLoaded", () => {
  ...
  const form = document.querySelector<HTMLFormElement>("#form-empresa-conveniada");
...
document.addEventListener("DOMContentLoaded", () => {
  const form = document.querySelector<HTMLFormElement>("#form-empresa-solicitante");
...
document.addEventListener("DOMContentLoaded", () => {
  const form = document.querySelector<HTMLFormElement>("#form-cadastro-paciente");
  const outputDiv = document.querySelector<HTMLDivElement>("#output");
...
document.addEventListener("DOMContentLoaded", () => {
  const form = document.querySelector<HTMLFormElement>("#form-agendamento-exames");
  const outputDiv = document.querySelector<HTMLDivElement>("#output");
